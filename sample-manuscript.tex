...
\section{Introducción}
   ...
   La remolacha o beterraga (\textit{Beta vulgaris} L.) es reconocida como una fuente concentrada de betalainas, nitratos y polifenoles cuyo consumo se ha relacionado con efectos vasodilatadores, actividad antioxidante y modulación antiinflamatoria \citep{Clifford2021,Siervo2016,WoottonBeard2011,Esatbeyoglu2015}%% FIXME: falta ref. Ninfali2013
   . Las betalainas, pigmentos responsables del color magenta-rojo, poseen cinética redox similar a la de compuestos fenólicos y carotenoides; sin embargo, su estabilidad depende fuertemente de la temperatura, el pH y la actividad de agua \citep{Stintzing2002}%% FIXME: falta ref. Wruss2015
...
%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%
%% FIXME: agregar referencias faltantes:
%% Ninfali2013, Wruss2015, Obreque2014, VieitesBarroso2023,
%% AlvarezJubete2010, Dias2020, Pankajan2022,
%% Simbaqueba2021, Delgado2019
